...
export default function HelpDialogContent({ onClose }) {
  ...
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={<><strong>Manage Portfolio:</strong> Manage and organize your cloud accounts and instances.</>}
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={<><strong>Explorer:</strong> Navigate and explore cost insights across your cloud data.</>}
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={<><strong>Download User Guide:</strong> Click the (📘) icon to download the CCA user guide.</>}
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={<><strong>Help section:</strong> Represented by the (?) icon, offers on-screen instructions and information about the current page.</>}
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={<><strong>Profile:</strong> Represented by the (👤) icon, displays the email ID of the logged-in user. To log out, click the icon and select the 'Logout' option.</>}
    />
  </ListItem>
</List>
...
<List sx={{ listStyleType: "decimal", pl: 3 }} component="ol">
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Select Cloud Service Provider:</strong> Choose the cloud service provider from the options (AWS, AZURE, GCP).
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Enter Portfolio Name:</strong> Provide a name for your portfolio to identify it easily.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={<strong>Update Instance Details:</strong>}
    />
  ...
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Add Instance:</strong> Click '+ Add Instance' to add the instance details to your portfolio.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Save Portfolio:</strong> Click 'Save' to store your portfolio with the added instance details.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>View Portfolios:</strong> After saving, you can view your portfolio in the portfolios list on the left side of the page.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>View Instances:</strong> Click on any portfolio account from the list to view the instances saved under that portfolio.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Delete Instance:</strong> Click on the delete icon next to the applicable instance row and confirm the deletion.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Cancel:</strong> Click 'Cancel' to discard the unsaved instances from the list.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Delete Portfolio:</strong> If needed, click on 'Delete Portfolio'.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Cost Advice:</strong> Click 'Cost Advice' to receive recommendations on AMD instances compared to your current instances.
        </>
      }
    />
  </ListItem>
...
<List sx={{ listStyleType: "decimal", pl: 3 }} dense component="ol">
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Download Template:</strong> Click on Template button to download the Excel template required for bulk uploading.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Fill in Template:</strong> Complete the template with instance details including uuid, cloud, region, size, quantity, Total Number of Hours per Month and Pricing Model.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Upload:</strong> Click 'Upload' and browse for the completed template file to upload it.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>View Uploaded Instances:</strong> After uploading, the instance details will be reflected in the table on the page.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Enter Portfolio Name:</strong> Provide a name for your new portfolio.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Save Portfolio:</strong> Click 'Save' to store the portfolio with the uploaded instance details.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>View Portfolios:</strong> After saving, you can see your portfolio in the portfolios list on the left side of the page.
        </>
      }
    />
  </ListItem>
  ...
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Delete Portfolio:</strong> To delete a portfolio, click 'Delete Portfolio'.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          <strong>Cost Advice:</strong> Click 'Cost Advice' to receive AMD recommendations and estimated savings.
        </>
      }
    />
  </ListItem>
...
<List sx={{ listStyleType: "decimal", pl: 3 }} dense>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          To delete all the error records at once, click on the <strong>"Delete Error Records"</strong> button.
        </>
      }
    />
  </ListItem>
  ...
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          To confirm, click the <strong>"Delete"</strong> button in the popup. This will remove all the error records from your list.
        </>
      }
    />
  </ListItem>
  <ListItem sx={{ display: "list-item" }}>
    <ListItemText
      primary={
        <>
          Click <strong>“Save”</strong> to apply changes. After saving, you can view the added portfolio in the portfolios list on the left side of the page.
        </>
      }
    />
  </ListItem>
